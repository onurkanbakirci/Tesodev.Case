...
public class UpdateOrderCommand : IRequest<IDataResult<GetOrderDto>>
{
    ...
    public UpdateOrderCommand(int productQuantity, double productUnitPrice, string productId, string productName, string productImageUrl, string addressLine, string city, string country, int cityCode)
    {
